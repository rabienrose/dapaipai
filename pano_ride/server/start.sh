...
scp *.sh root@39.105.230.163:~/pano_map/
scp -r vslam/src root@39.105.230.163:~/pano_map/vslam/src
...
docker run -d --rm --name pano_process --mount type=bind,source=/root/pano_map,dst=/workspace -w /workspace slam_insta python3 init_process.py
